...
macro_rules! tag_table {
    ($macro:path) => {
        $macro! {
            ...
            [23 AxisFlags       Byte        unbox   <crate::math::axisflags::AxisFlags>                     ]
            [24 FaceFlags       Byte        unbox   <crate::voxel::faceflags::FaceFlags>                    ]
            [25 Rgb             NonByte     unbox   <crate::rendering::color::Rgb>                          ]
            [26 Rgba            NonByte     unbox   <crate::rendering::color::Rgba>                         ]
            [27 IVec2           NonByte     unbox   <glam::IVec2>                                           ]
            [28 IVec3           NonByte     unbox   <glam::IVec3>                                           ]
            [29 IVec4           NonByte     box     <glam::IVec4>                                           ]
            [30 Vec2            NonByte     unbox   <glam::Vec2>                                            ]
            [31 Vec3            NonByte     unbox   <glam::Vec3>                                            ]
            [32 Vec4            NonByte     box     <glam::Vec4>                                            ]
            [33 Mat2            NonByte     box     <glam::Mat2>                                            ]
            [34 Mat3            NonByte     box     <glam::Mat3>                                            ]
            [35 Mat4            NonByte     box     <glam::Mat4>                                            ]
